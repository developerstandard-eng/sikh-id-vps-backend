...
const adminNominationsRoutes = require('./routes/admin-nominations.routes');
...
app.use('/api/v1/admin/nominations', adminNominationsRoutes);
app.use('/api/v1', nominationsRoutes);
